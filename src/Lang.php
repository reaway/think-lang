...
namespace Think\Component\Lang;
...
class Lang
{
     ...
     * @return string
     */
    public function defaultLangSet(): string
    {
     ...
     * @return void
     */
    public function switchLangSet(string $lang): void
    {
        if (empty($lang)) {
            return;
        }

        $this->setLangSet($lang);
    }
     ...
     * @return array
     */
    public function load(array|string $file, string $range = ''): array
    {
